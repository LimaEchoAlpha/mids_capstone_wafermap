...
def plot_wafers(images, true_labels, bad_labels=None, fig_size=(8, 8), cmap='gray_r',
                save=False, filename=None, dpi=1000):
    """
    Helper function to plot a 3x3 grid of grad-cam examples.
    
    :param images: -> list of images to plot
    :param true_labels -> list of the wafers' true labels
    :param bad_labels -> list of what wafers were mislabeled as
